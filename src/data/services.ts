...
export const services: Service[] = [
  ...
  },
  {
    ...
    note: 'Book multiple sessions if you need ongoing support — many people do one session, try things for 2–3 weeks, then come back with sharper questions.',
    ctaLink: 'https://topmate.io/jitangupta',
    tier: 'individual',
  },
  {
  ...
  },
  {
    ...
    whoFor: [
      'Engineering teams (3–7 people) where AI adoption is uneven',
  ...
  },
  {
    ...
    note: "Different from Team Training: Training teaches your team to use AI in their existing work. Build-Along produces a specific new thing that didn't exist before. If your team needs both, book Training first — the training makes the build-along dramatically more productive. Best for 2–5 people; above 5, some people end up watching instead of building.",
    ctaLink: 'https://topmate.io/jitangupta',
    tier: 'team',
  },
];
